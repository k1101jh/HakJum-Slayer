...
public class Book : SliceableObject {
    ...
    public float minRotationForce = 20f;
    public float maxRotationForce = 40f;
    ...
    override public void Slice()
    {
        ...
        Vector3 torque = transform.right * Random.Range(minRotationForce, maxRotationForce) * (Random.Range(0, 2) * 2 - 1);
